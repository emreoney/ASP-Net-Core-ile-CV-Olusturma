<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminHobiler.aspx.cs" Inherits="BLogResume.AdminHobiler" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        ...
        <asp:HyperLink NavigateUrl="~/AdminHobiEkle.aspx" ID="HyperLink3" CssClass="btn btn-success" runat="server">Hobi Ekle</asp:HyperLink>

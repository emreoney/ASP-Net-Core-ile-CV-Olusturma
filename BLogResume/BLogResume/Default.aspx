<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BLogResume.Default" %>
...
<head>
    ...
    <link href="Dosyalar/css/resume.css" rel="stylesheet" />
</head>
...
<body id="page-top">
            ...
            <asp:Repeater ID="Repeater4" runat="server">
                <ItemTemplate>
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-3">
                            <asp:Label ID="Label15" runat="server" Text='<%# Eval("YETENEK") %>'></asp:Label>
                        </div>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
        <h2 class="mb-5">İLGİ ALANLARIM</h2>
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="awards">
        <h2 class="mb-5">SERTİFİKA VE ÖDÜLLERİM</h2>
